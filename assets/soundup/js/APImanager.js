...
/**
  ...
  */
  getMostPopular: function(){
    ...
    url = "https://api.spotify.com/v1/search?q=year:1980-2016&type=album&limit=50&offset=0"
    method = "GET";
...
/**
  ...
  */
  ...
  y_request: function(method, url){
      ...
      //var results = YouTube.Search.list('id,snippet', {q: mid, maxResults: 25});
...
/**
  ...
  */
  y_getVideo: function(artist, name){
      //YoutubeManager.initClient();
      //YoutubeManager.yinit();
      ...
      req.execute(function(response){
        var youtube_id = response.items[0].id.videoId;
        var url = "http://www.youtube.com/embed/"+youtube_id;
        Listener.refreshVideo(url);
      });
      ...
      //var j = YouTube.Search.list('id,snippet', {q: mid, maxResults: 25});
